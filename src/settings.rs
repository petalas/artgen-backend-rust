...
pub const MAX_ERROR_PER_PIXEL: f32 = 441.67297; // sqrt(255.0 * 255.0 * 3.0) — used by CPU path
pub const GPU_MAX_ERROR_PER_PIXEL: f32 = 765.0; // 255 * 3 — L1 distance used by GPU path
...
pub const GPU_CHAIN_COUNT: u32 = 512;
