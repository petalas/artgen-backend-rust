...
fn get_param_by_name(params: &MutationParams, name: &str) -> f32 {
    match name {
        ...
        "scale_polygon_prob" => params.scale_polygon_prob,
        "rotate_polygon_prob" => params.rotate_polygon_prob,
        "adjacent_swap_prob" => params.adjacent_swap_prob,
        "merge_polygon_prob" => params.merge_polygon_prob,
        "clone_polygon_prob" => params.clone_polygon_prob,
        "medium_move_prob" => params.medium_move_prob,
        "swap_colors_prob" => params.swap_colors_prob,
        ...
        "medium_move_delta" => params.medium_move_delta,
        "merge_centroid_threshold" => params.merge_centroid_threshold,
        "merge_color_threshold" => params.merge_color_threshold,
...
fn set_param_by_name(params: &mut MutationParams, name: &str, value: f32) {
    match name {
        ...
        "scale_polygon_prob" => params.scale_polygon_prob = value,
        "rotate_polygon_prob" => params.rotate_polygon_prob = value,
        "adjacent_swap_prob" => params.adjacent_swap_prob = value,
        "merge_polygon_prob" => params.merge_polygon_prob = value,
        "clone_polygon_prob" => params.clone_polygon_prob = value,
        "medium_move_prob" => params.medium_move_prob = value,
        "swap_colors_prob" => params.swap_colors_prob = value,
        ...
        "medium_move_delta" => params.medium_move_delta = value,
        "merge_centroid_threshold" => params.merge_centroid_threshold = value,
        "merge_color_threshold" => params.merge_color_threshold = value,
...
pub fn default_param_specs() -> Vec<ParamSpec> {
    vec![
        ...
        ParamSpec { name: "scale_polygon_prob".into(), kind: ParamKind::LogScale { min: 1e-4, max: 0.1 }, enabled: true },
        ParamSpec { name: "rotate_polygon_prob".into(), kind: ParamKind::LogScale { min: 1e-4, max: 0.1 }, enabled: true },
        ParamSpec { name: "adjacent_swap_prob".into(), kind: ParamKind::LogScale { min: 1e-4, max: 0.1 }, enabled: true },
        ParamSpec { name: "merge_polygon_prob".into(), kind: ParamKind::LogScale { min: 1e-4, max: 0.1 }, enabled: true },
        ParamSpec { name: "clone_polygon_prob".into(), kind: ParamKind::LogScale { min: 1e-4, max: 0.5 }, enabled: true },
        ParamSpec { name: "medium_move_prob".into(), kind: ParamKind::LogScale { min: 1e-4, max: 0.5 }, enabled: true },
        ParamSpec { name: "swap_colors_prob".into(), kind: ParamKind::LogScale { min: 1e-4, max: 0.1 }, enabled: true },
        // Deltas (Linear)
        ...
        ParamSpec { name: "medium_move_delta".into(), kind: ParamKind::Linear { min: 0.001, max: 0.1 }, enabled: true },
        ParamSpec { name: "merge_centroid_threshold".into(), kind: ParamKind::Linear { min: 0.01, max: 0.5 }, enabled: true },
        ParamSpec { name: "merge_color_threshold".into(), kind: ParamKind::Linear { min: 0.01, max: 0.5 }, enabled: true },
        // Crossover (Linear)
